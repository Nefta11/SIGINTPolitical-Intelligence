...
IMPORTANTE: El territorio de análisis es "${territory}". Todos los candidatos, narrativas, arquetipos y cifras deben corresponder EXCLUSIVAMENTE a ${territory}, no a ningún otro país o territorio.
...
Identifica los 4 candidatos con mayores posibilidades de contender a la presidencia o al cargo ejecutivo más relevante de ${territory} en el próximo período.
Basándote EXCLUSIVAMENTE en presencia digital activa, menciones, y relevancia en la conversación política de ${territory}.

Para cada candidato: 4 adjetivos que el universo digital de ${territory} le atribuye (no tu opinión).
REGLA DE RESALTE:
